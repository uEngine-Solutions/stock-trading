...
pluralCaseList.push( {plural: "trades", pascal: "Trade"} )
pluralCaseList.push( {plural: "bids", pascal: "Bid"} )
pluralCaseList.push( {plural: "asks", pascal: "Ask"} )


pluralCaseList.push( {plural: "prices", pascal: "Prices"} )

pluralCaseList.push( {plural: "assets", pascal: "Asset"} )
